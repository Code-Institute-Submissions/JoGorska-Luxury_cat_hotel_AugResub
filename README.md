...
The link to the deployed page can be found [here](https://jogorska.github.io/Luxury_cat_hotel/)
...
- accessibility of icons for screen readers users information found [here](https://fontawesome.com/v5.15/how-to-use/on-the-web/other-topics/accessibility)

- pattern for emails - input form validation for emails and other uses of pattern attribute found [here](https://www.w3schools.com/tags/att_input_pattern.asp)

- UK counties drop down list found [here](https://gist.github.com/olivertappin/4dcbf64e06aae132c12a8b9d302fae12)

- color palette generated by [Coolors](https://coolors.co/)

- photos compressed at [Tiny Png](https://tinypng.com/)
